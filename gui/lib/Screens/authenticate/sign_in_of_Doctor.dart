...
class sign_in_doctor extends StatefulWidget {
  ...
  sign_in_doctor({this.toggleView});
...
class _sign_in_doctorState extends State<sign_in_doctor> {
  ...
  getProfileData(String id) async {
    ...
    var url = Uri.parse("https://doctor-at-home.herokuapp.com/api/doctor/${id}");
              ...
              RaisedButton(
                ...
                onPressed: () async{
                  if(_formKey.currentState.validate()){
                    ...
                    Doctor result = await _auth.signInWithDoctorEmailAndPassword(email,password);
                    bool isDoctor = await getProfileData(email);
                    if(result == null || !isDoctor){
